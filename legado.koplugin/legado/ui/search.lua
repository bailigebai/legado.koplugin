...
function SearchView.new(options)
    ...
    return setmetatable({ kind = "search", service = options.service, source_provider = options.source_provider, alive = true, loading = false, results = {}, errors = {}, request = nil, onUpdate = options.onUpdate }, SearchView)
end
