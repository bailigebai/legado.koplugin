...
case("xpath axes, values, and approved predicates", function()
    ...
    equal(nil, parse_ok(engine, fixtures.html, ".//a[contains(@class,'primary')][contains(text(),'Alpha')]/@href", {}, false))
    equal("note", parse_ok(engine, fixtures.html, "//p[contains(text(),'Tail')]/@class", {}, false))
