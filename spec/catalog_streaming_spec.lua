...
f.scheduler:runAll();f.requests[3].reply(nil,{code='TIMEOUT'})
f.scheduler:runAll();f.requests[4].reply(nil,{code='TIMEOUT'})
...
side:goPage(3);f:reply(5,1,60);f.scheduler:runAll()
